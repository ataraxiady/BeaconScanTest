package com.example.beaconscantest.api.core;

import android.content.Context;

import com.example.beaconscantest.api.core.interceptor.AddCookieInterceptor;
import com.example.beaconscantest.api.core.interceptor.ReceivedCookieInterceptor;
import com.example.beaconscantest.api.resource.APIUrl;
...
public class APIAdapter {
    ...
    protected static Object retrofit(Context context, Class<?> serviceName){
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .addNetworkInterceptor(new AddCookieInterceptor(context))
                .build();
         ...
         *
         * ex) retrofit.create(~~Service.class);
         */
